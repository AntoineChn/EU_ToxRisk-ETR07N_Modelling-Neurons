...
Analysis suggests and some preliminar stan fits (calibrations) show that
...
Wang decides to impose / transform these  problematic parameters as following
...
- in this stage, Wang sets the prior of $x_{50}$ to be somewhere near 10
